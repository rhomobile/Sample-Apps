(function($){
    ...
    var	$html = $( "html" ),
            $head = $( "head" ),
            $window = $( window );
    var original_showPageLoadingMsg = $.mobile.showPageLoadingMsg;
    $.mobile.showPageLoadingMsg = function(loadingMessage) {
        loadingMessage = loadingMessage || $.mobile.loadingMessage;
        if ( loadingMessage ) {
